...
class MpesaStkpush
{
    ...
    public function __construct(){
        $this->short_code = '4092475';
        $this->parent_short_code='4092475';
        $this->consumer_key="dxgZK09pFBtJynxlgf51Fii5WRLBNoJt"; //Your Consumer key
        $this->consumer_secret="vT8ZvfofPGJFZOG0"; //Your Secret key
        $this->passkey = "8f62a516b3e1e68a7120bb499b078e20d88520af53401d3589e4e7a7e288ed83"; //Your Passkey
        $this->CallBackURL = " "; //Your callback URL
        $this->env = "live"; //Your Environment sandbox or Live
