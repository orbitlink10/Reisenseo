     ...
     <div class="col-lg-8 col-xl-8">
       ...
       <div class="card">
         <div class="card-header">
          <h3 class="card-title">Payment checkout for {{ $package->title }}</h3>
        </div>
        <div class="card-body">
          <div class="card-pay">
            ...
            <script type="text/javascript">
              ...
              function showPaypal() {
               ...
               document.getElementById('showMpesa').style.display = "none";
             }

             function showMpesa() {
               document.getElementById('showMpesa').style.display = "block";
...
<p>We are making a call to your number {{ $sale->phone }}, within the next 10 minutes and guide the process</p>

          @endif


          <div id="showMpesa" style="display: none;">
            ...
            <div class="form-group" style="padding: 10px;">
              ...
              <div class="col-sm-8">
                ...
                <input type="hidden" id="amount" placeholder="amt" value="{{ floatval($package->cost) * floatval(get_option(site_id().'_usd_kes', 1)) }}">

                
                <input type="hidden" id="pay_type" placeholder="amt" value="checkout">

                <input type="hidden" id="account" placeholder="account" value="{{ $package->id }}">
              </div>
                  ...
                  $.ajax({
                    ...
                    success: function(data) {
                      ...
                      if (data.msg == "The service request is processed successfully."){
                           ...
                           window.location = "{{ route('success_website', $sale->id) }}";
                      }
                      if(data.msg =="DS timeout user cannot be reached" || data.msg == "The initiator information is invalid."){
                        document.getElementById("result").innerHTML = '<i class="glyphicon glyphicon-info-sign"></i> Something went wrong with your payment, Please try again... and check your phone to input mpesa pin <br> <a href="{{ url("cpay/".$sale->id)}}" class="btn btn-info">Try Again</a>';
                        $('#modal-loader3').hide();
                        $('#mpesa').hide();
                      }
        ...
        <div id="showPaypal" style="display: none;">
        ...
        <script src="https://www.paypal.com/sdk/js?client-id={{ get_option(site_id().'_paypal_client_id') }}&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory">
        </script>
            ...
            paypal.Buttons({
              ...
              createOrder: function(data, actions) {
                return actions.order.create({
                  purchase_units: [{"amount":{"currency_code":"USD","value":{{ $package->cost }}}}]
                });
              },
...
<div class="col-xl-4 col-md-12">
  ...
  <div class="card cart">
    ...
    <div class="card-body">
      <h3 class="card-title">Buy {{ $package->title }}</h3>
    ...
    <li class="list-group-item border-0">
         Package cost
          <span class="h4 fw-bold mb-0 float-end"> USD {{ floatval($package->cost) * floatval(get_option(site_id().'_usd_kes'))}} </span>
        </li>


        <li class="list-group-item border-0">
          Product cost
          <span class="h4 fw-bold mb-0 float-end"> KES {{ $package->cost  }} </span>
        </li>
        <li class="list-group-item border-0">
          Discount
