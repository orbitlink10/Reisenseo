...
@section('description') @if( ! empty(get_option(site_id().'_show_2_meta'))){{ substr(trim(preg_replace('/\s\s+/', ' ',strip_tags(get_option(site_id().'_show_2_meta')))),0,160) }}@endif @endsection
@section('content')
