                                                ...
                                                <div class="card">
                                                    <div class="product-grid6">
                                                        <div class="product-image6 p-5">
                                                            <ul class="icons">
                                                                <li>
                                                                    <a href="{{ post_path($product->slug) }}" class="btn btn-primary"> <i class="fe fe-eye">  </i> </a>
                                                                </li>
                                                            ...
                                                            <a href="{{ post_path($product->slug) }}" >
                                                                <img class="img-fluid br-7 w-100" src="assets/images/pngs/9.jpg" alt="img">
                                                            </a>
                                                        </div>
                                                        <div class="card-body pt-0">
                                                            <div class="product-content text-center">
                                                                <h1 class="title fw-bold fs-20"><a href="{{ post_path($product->slug) }}">Candy Pure Rose Water</a></h1>
