          ...
          <div id="showMpesa" style="display: none;">
            ...
            <div class="form-group" style="padding: 10px;">
              ...
              <div class="col-sm-8">
                ...
                <input type="hidden" id="amount" placeholder="amt" value="{{ $package->cost*get_option(site_id().'_usd_kes') }}">
...
<div class="col-xl-4 col-md-12">
  ...
  <div class="card cart">
    ...
    <li class="list-group-item border-0">
         Package cost
          <span class="h4 fw-bold mb-0 float-end"> USD {{ $package->cost * get_option(site_id().'_usd_kes')}} </span>
        </li>
