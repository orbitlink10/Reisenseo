     ...
     <div class="col-lg-8 col-xl-8">
       ...
       <div class="card">
         <div class="card-header">
          <h3 class="card-title">Buy script</h3>
        </div>
        <div class="card-body">
          <div class="card-pay">
...
<p>We are ready to do an installation for you, a developer will make a call to your number {{ $sale->phone }}, within the next 10 minutes and guide the process</p>
          ...
          <div id="showMpesa" style="display: none;">
            ...
            <div class="form-group" style="padding: 10px;">
              ...
              <div class="col-sm-8">
                ...
                <input type="hidden" id="amount" placeholder="amt" value="{{ $package->amount*get_option(site_id().'_usd_kes') }}">
            ...
            paypal.Buttons({
              ...
              createOrder: function(data, actions) {
                return actions.order.create({
                  purchase_units: [{"amount":{"currency_code":"USD","value":{{ $package->amount }}}}]
                });
              },
...
<div class="col-xl-4 col-md-12">
  ...
  <div class="card cart">
    ...
    <li class="list-group-item border-0">
         Package cost
          <span class="h4 fw-bold mb-0 float-end"> USD {{ $package->amount }} </span>
        </li>


        <li class="list-group-item border-0">
          Product cost
          <span class="h4 fw-bold mb-0 float-end"> KES {{ $package->amount * get_option(site_id().'_usd_kes') }} </span>
        </li>
        <li class="list-group-item border-0">
          Discount
