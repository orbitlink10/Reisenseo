        ...
        <div class="main-container container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <a target="_blank" href="{{ route('edit_product', $product->id) }}">Edit Product</a>
                    @endif
                    @endif
                                                    ...
                                                    <div class="">
                                                      ...
                                                      <div class="carousel-item active">
                                                        ...
                                                        <div class="carousel-item">  
                                                            ...
                                                            <img src="{{ get_option(site_id().'_main_site_url') }}/{{ $upload->file_path }}" alt="img" class="img-fluid mx-auto d-block">
                                                ...
                                                <div id="thumbcarousel" class="carousel slide" data-bs-interval="t">
                                                    <div class="carousel-inner">
                                                        <ul class="carousel-item active">
                                                            <?php $x=0; ?>
                                                            @foreach($uploads as $upload)
                                                            <li data-bs-target="#Slider" data-bs-slide-to="{{ $x }}" class="thumb active m-2"><img src="{{ get_option(site_id().'_main_site_url') }}/{{ $upload->file_path }}" alt="img"></li>
                                                            <?php $x=$x+1; ?> 
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                ...
                                <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                    <div class="mt-2 mb-4">
                                        ...
                                        <div class="btn-list mt-4">
                                           ...
                                           class="fe fe-play me-2"></i> View Live Demo
                                       </a>
                                       ...
                                       <a href="{{ route('pregister', ['id' => $product->id ]) }}"
                                         ...
                                         class="fa fa-sign-in me-2"></i>Buy Now
                                     </a> 
                                 </div>
                             </div>
                         </div>
