...
<div class="demo-screen-headline main-demo main-demo-1 spacing-top overflow-hidden reveal bg-landing pb-0 bg-image-style" id="home">
    ...
    <h4 class="fw-semibold mt-7">{{ get_option(site_id().'_tagline') }}</h4>
              <h1 class="text-start fw-bold">{{ get_option(site_id().'_hero_header') }}</h1>
              <p class="pb-3" style="font-size: 20px;">
                 {{ get_option(site_id().'_hero_description') }}
...
<div class="col-xl-5 col-lg-5 my-auto">
    <img src="assets/images/landing/market5.png" alt="{{ get_option(site_id().'_site_name') }}">
    <br><br>
...
<!-- ROW-4 OPEN -->
<div class="section " style="background-color: #F0F5FD;">
    <div class="container">
 ...
 <div class="row">
    <div class="">
        ...
        <h2 class="text-center fw-semibold">{{ get_option(site_id().'_expert_header') }}</h2>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 ps-0">
                                    <div class="text-center reveal revealleft mb-3">
                                        <img src="assets/images/landing/business-team-working-on-business-plan3.png"
...
<div class="demo-screen-headline main-demo main-demo-1 spacing-top overflow-hidden reveal bg-landing pb-0 bg-image-style" id="home">
  ...
  <div class="container px-sm-0">
    <h2 class="text-center fw-bold">{{ get_option(site_id().'_ctah') }}</h2>
            ...
            <div class="row">
               <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                   <div class="card p-3 pricing-card reveal revealrotate">
                    <div class="card-body">
                      {!! get_option(site_id().'_show_1_content') !!}  
                  </div>
              </div>
          </div>
