        ...
        <div class="main-container container-fluid">
            <div class="row">
                ...
                <div class="col-9">
                    ...
                    @include('flash_msg')
                    <div class="card">
                        <div class="card-header"><strong>Add Programme</strong></div>


                        <div class="card-body">
                            <form method="POST" action="{{ route('anew_training') }}">
                                @csrf
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <select class="form-control" name="parent_page">
                     <?php
                     $page_name = \App\Models\Page::whereId(22)->first()->name;
...
<div class="card">
    ...
    <a target="_blank" href="{{ route('training_description', $post->slug)}}"  class="h4 text-dark">{{ $post->title}}</a>
    ...
    ?>
    @if($site)
    <p style="color: green;"><a href="{{ route('edit_training', $post->id) }}"> Edit</a> @if($post->site_id)| <a style="color: green;" href="https://{{ $site->domain_name }}" target="_blank">{{ $site->domain_name }}</a>@endif</p>
    @endif
    <hr>
