     ...
     <div class="card">
       ...
       <div class="card-pay">
           <ul class="tabs-menu nav">
               ...
               <li>
                  <a href="{{ route('new_professional_service') }}"  class="payment-icon active">  Professional Service</a>
                </li> 
  @if(get_option(site_id().'_enable_academic_writing') == 'academic')
                 <li class=""><a href="{{ route('add_order') }}" class="payment-icon">Academic Writing</a>
                 </li>
          ...
          <form class="form-horizontal" method="POST" action="{{ route('professional_order') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="order_level" value="professional">
            <div class="row">
                <div class="col-sm-12">
                   ...
                   <div class=" row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="" name="title" class="form-control" placeholder="Enter subject" required="">
                    </div>
                </div>
             ...
             <div class=" row mb-4">
                    <label class="col-md-3 form-label">What service do you need?
</label>
                    <div class="col-md-9">
