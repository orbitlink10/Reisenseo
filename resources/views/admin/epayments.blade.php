      ...
      <div class="card">
       <div class="card-header border-bottom-0">
         ...
         <div class="page-options ms-auto">
          ...
          <a href="{{ route('epayments', ['status'=>'1']) }}" class="btn btn-primary btn-sm"> Unpaid </a>

                    <a href="{{ route('epayments', ['status'=>'2']) }}" class="btn btn-primary btn-sm"> Pending </a> 
          <a href="{{ route('epayments', ['status'=>'3']) }}" class="btn btn-success btn-sm"> Paid </a>
                 <?php 
           ...
           <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content country-select-modal">
               <div class="modal-header">
                 <h6 class="modal-title">Request payments  KES {{ editor_balance(Auth::user()->id) }} for unpaid orders</h6><button aria-label="Close" class="btn-close"
     ...
     <table class="table border-top table-bordered mb-0">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td class="text-nowrap align-middle"><span>{{price($property->ecost)}}</span></td>
