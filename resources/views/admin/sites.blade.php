     ...
     <div class="col-lg-8 col-xl-8">
       ...
       <div class="card">
         ...
         <div class="card-header border-bottom-0">
           <h2 class="card-title">Site list</h2>
         ...
         <div class="card-body">
          <div class="row">
           ...
           <div class="col-sm-3">
            ...
            <a target="_blank" href="https://{{ $user->domain_name }}">{{ $user->domain_name }}</a> {{ $user->label }}<br>
                <img src="{{ $user->logo_url }}" width ="400" >
          </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
   <div class="modal-content country-select-modal">
     <div class="modal-header">
       <h6 class="modal-title">Delete site #{{ $user->id }}</h6><button aria-label="Close" class="btn-close"
       data-bs-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
     </div>
     <div class="modal-body">
       <form class="form-horizontal" action="{{ route('delete_site')}}" method="POST">
         @csrf
           ...
           <div class="col-md-9">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content country-select-modal">
                ...
                <div class="modal-body">
                  <form class="form-horizontal" action="{{ route('update_site')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class=" row mb-4">
                      ...
                      <div class=" row mb-4">
                      <label class="col-md-3 form-label">Logo (400x100)</label>
                    ...
                    <div class=" row mb-4">
                      <label class="col-md-3 form-label">Fatured Image (500x400)</label>
