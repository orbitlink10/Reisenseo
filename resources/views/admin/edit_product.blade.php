...
<div class="page-options ms-auto">
            ...
            <a target="_blank" href="{{ route('blog_single', $post->slug)}}"  class="btn btn-primary btn-sm">{{ $post->slug}}</a>
            @elseif($post->parent_page == 7)
            <a target="_blank" href="{{ route('question_single', $post->slug)}}"  class="btn btn-primary btn-sm">Preview </a>
            @elseif($post->parent_page == 10)
            <a target="_blank" href="{{ route('sample_single', $post->slug)}}"  class="btn btn-primary btn-sm">Preview</a>
            @elseif($post->parent_page == 12)
            <a target="_blank" href="{{ route('programming_single', $post->slug)}}"  class="btn btn-primary btn-sm">Preview</a>
            @else
            <a target="_blank" href="{{ route('blog_single', $post->slug)}}"  class="btn btn-primary btn-sm">Preview</a>
            @endif
          </div>
